...
namespace Potential
{
    public class Particle : GameObject
    {
        ...
        public Particle(Texture2D texture, Vector3 position, Vector3 velocity, float radius = 10.0f, float mass = 0, float charge = 0, float rotation = 0.0f, float angular_velocity = 0.0f, bool isfixed = false)
        {
            Texture = texture;
            Position = position;
            Velocity = velocity;
